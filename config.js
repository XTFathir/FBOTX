...
global.titlebot = `FBOT`
global.stickpack = ' '
global.stickauth = ` `
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= 'FathirA'
global.nameown2 = ' '
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
...
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA SOSSIAL ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = 'https://instagram.com/fathir.alfaruq'
global.sgh = 'https://github.com/XT-FTR' //github
global.sgc = 'https://chat.whatsapp.com/I4tVngAcy31LDv2WMOnJDw' //group whatsapp
global.sdc = '-' //discord
global.snh = '-'
